         ...
         <table>
            ...
            <tbody>
               ...
               for (int i = 1; i <= lastDay; i++) {
                   ...
                   out.print("<button disabled class=\"scl\" id=\"bin\" style=\"font-size: 12px; position: relative; bottom: 100%; right: calc(" + buttonStartRightPercentage + "% + 10px); background-color: #1C427E; color: white; padding: 0px; max-height: 20px;\" onclick=\"location.href='Scl_Cal.jsp';\">일정이 있습니다.</button>");
                   // 버튼 출력 부분 수정 끝
